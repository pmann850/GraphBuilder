...
- Direct Data   - Nodes and relationships are built directly from data imported (i.e. data is pulled from multiple sources. pk and fk ids are used to build relationships)
...
- Derived Data  - Nodes can be derived from attribute values (i.e. specialty can be derived from certifications. certification becomes a relationship of a doctor to a specialty.)
